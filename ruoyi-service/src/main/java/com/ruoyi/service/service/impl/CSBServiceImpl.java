...
//    private final String encryptKey = "bko8fnu2570b6qpy";
     ...
     */
    @Override
    public JSONObject auth_encrypt(String signNo) {
        // 设置请求参数（json格式)
        Map<String, String> param = new HashMap<>();
        param.put("signNo", signNo);
        return getJSONObject("auth_encrypt", param);
    }
     ...
     */
    @Override
    public JSONObject qrcode_channel_encrypt(String systemName) {
        // 设置请求参数（json格式)
        Map<String, String> param = new HashMap<>();
        param.put("systemName", systemName);
        return getJSONObject("qrcode_channel_encrypt", param);
    }

<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['service:menu:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['service:menu:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="menuList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="路由参数" align="center" prop="param" />
      <el-table-column label="是否为外链" align="center" prop="isFrame">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_zero_one" :value="scope.row.isFrame"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="路由参数" prop="param">
          <el-input v-model="form.param" placeholder="请输入路由参数" />
        </el-form-item>
        <el-form-item label="是否为外链">
          <el-radio-group v-model="form.isFrame">
            <el-radio
              v-for="dict in dict.type.sys_zero_one"
              :key="dict.value"
...
<script>
import { listMenu, getMenu, delMenu, addMenu, updateMenu } from "@/api/service/menu";

export default {
  name: "Menu",
  dicts: ['sys_zero_one', 'sys_show_hide'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除首页菜单编号为"' + menuIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('service/menu/export', {
        ...this.queryParams
